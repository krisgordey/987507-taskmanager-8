...
${cardData.isRepeating ? `card--repeat` : ``} ${isExpiredTask(cardData.dueDate) ? `card--deadline` : ``}">
            <form class="card__form" method="get">
              <div class="card__inner">
                <div class="card__control">
                  ...
                  <button
                    type="button"
                    class="card__btn card__btn--favorites ${cardData.isFavorite ? `` : `card__btn--disabled`}"
                  >
                    favorites
                  </button>
                </div>
            ...
            <div class="card__details">
              <div class="card__dates">
                ...
                ${cardData.dueDate ? `<fieldset class="card__date-deadline">
                  ...
                  <label class="card__input-deadline-wrap">
                    <input
                      class="card__time"
                      type="text"
                      placeholder="${formatAMPM(cardData.dueDate)}"
                      name="time"
                      value="${formatAMPM(cardData.dueDate)}"
                    />
                  </label>
                </fieldset>` : ``}
    
                <button class="card__repeat-toggle" type="button">
                  repeat:<span class="card__repeat-status">${cardData.isRepeating ? `yes` : `no`}</span>
                </button>
               
                
                ${cardData.isRepeating ? `<fieldset class="card__repeat-days">
                  <div class="card__repeat-days-inner">
                    ${getRepeatingDaysMarkup(cardData.repeatingDays)}
                  </div>
                </fieldset>` : ``}
               </div>
              ...
              <div class="card__hashtag">
                ...
                ${cardData.tags ? getTags(cardData.tags) : ``}
                </div>
